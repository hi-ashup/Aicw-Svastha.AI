...
export const TotalHealthPointsAtom = atom<number>(0);
...
export const ScanHistoryAtom = atom<ScanHistoryItem[]>([]);

export type ViewType = 'home' | 'dashboard' | 'analysis' | 'history';
...
export const CompareItemsAtom = atom<BoundingBox2DType[]>([]);
export const HiddenAyurvedaFiltersAtom = atom<string[]>([]);
export const IsCompareSidebarOpenAtom = atom<boolean>(true);
